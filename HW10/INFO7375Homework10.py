...
class Model:
    def __init__(self, layer_dims, learning_rate=0.03, activation='relu', keep_probs=None):
        self.layer_dims = layer_dims
        self.learning_rate = learning_rate
        self.activation = activation
        self.keep_probs = keep_probs  # Add dropout probabilities
    ...
    def train(self, X, Y, num_iterations=3000, X_train=None, Y_train=None, X_test=None, Y_test=None):
        ...
        for i in range(0, num_iterations):
            # Use training=True for training (with dropout)
